...
public class Constants {
    ...
    public static final String ON_SELF_FIGHT_CALL = "%s пошёль нахой";
    public static final String ON_UNKNOWN_COMMAND_HELP_CALL = "Тебе уже сказали, шо ты ебобо?";
    public static final String ON_HELP_HELP_CALL = "Ну ты шо, ебобо?";
    public static final String ON_NON_EXISTING_RANK = "%s а ранг ты дома не забыл?";
    public static final String ON_LOW_RANK_CALL = "Ранг свой чекни, быдло %s";
    ...
    public static final String ON_DATE_TOO_EARLY_CALL = "%s братик, ты что то рановато, пиздуй отсюда";
