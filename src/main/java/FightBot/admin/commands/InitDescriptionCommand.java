    ...
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
        ...
        builder7.setTitle("Правила вызова соперника")
                        .setDescription("Вы можете вызвать соперника если:\n\n" +
                                "1. Соперник не ниже вас по рангу (не дивизиону) и не выше более чем на 5 дивизионов.\n\n" +
                                "2. Вы не проводили бой с соперником в этот день (календарный).\n\n" +
                                "3. У вас и у соперника нет активного боя или вызова.\n\n" +
                                "4. Соперник, которого вы пытаетесь вызвать, имеет активный статус (пометил, что он активен).\n\n" +
                                "5. Вы, также как и соперник, можете отменить вызов до его принятия.\n\n" +
                                "6. Вызов может принять только соперник.");
        ...
        builder4.setTitle("Окончание боя")
                        .setDescription("1. Для окончания боя оба игрока должны нажать на одно и то же имя победителя.\n\n" +
                                ...
                                "3. После окончания боя, если разница в дивизионах до окончания боя была менее 4, " +
                                "дивизион проигравшего игрока будет снижен на 1, дивизион победившего игрока будет повышен на 1.\n\n" +
                                "4. Если разница в дивизионах игроков до окончания боя составляла 4 или 5 и победил игрок с " +
                                "меньшим дивизионом, то его дивизион будет повышен на 2, а дивизион проигравшего игрока будет снижен на 2.");
